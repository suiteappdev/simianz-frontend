...
function configState($stateProvider, $urlRouterProvider, $compileProvider, $httpProvider) {
        ...
        return {
            'request': function(config) {
                ...
                if(window.localStorage.token){
                   $httpProvider.defaults.headers.common['x-simianz-auth'] =  window.localStorage.token ; // common
                }
    ...
    $stateProvider
        ...
        .state('cambiar-clave', {
            ...
            templateUrl: "views/school/cambiar-clave.html",
        ...
        .state('viajes', {
            url: "/viajes",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/viajes.html",
            data: {
                pageTitle: 'viajes'
            }
        })
        .state('detalle-viaje', {
            url: "/detalle-viaje",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/detalle-viaje.html",
            data: {
                pageTitle: 'Detalle viaje'
            },
            params : {viaje : null}
        })
        .state('dashboard', {
        ...
        .state('acudiente', {
            url: "/acudientes",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/acudiente.html",
            data: {
                pageTitle: 'Acudiente'
            }
        })
        .state('colegio', {
            url: "/colegio",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/colegio.html",
            data: {
                pageTitle: 'Colegio'
            }
        })
        .state('parada', {
            ...
            templateUrl: "views/school/parada.html",
            data: {
                pageTitle: 'Parada'
            }
        })
        .state('conductor', {
            url: "/conductores",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/conductor.html",
            data: {
        ...
        .state('monitor', {
            url: "/monitores",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/monitor.html",
            data: {
                pageTitle: 'Monitores'
            }
        })
        .state('rutas', {
            url: "/rutas",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/rutas.html",
            controller : 'rutaCtrl',
            data: {
                pageTitle: 'Rutas'
            }
        })
        .state('rutas-estudiante', {
            url: "/rutas-estudiante",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/rutas.html",
            controller : 'rutaCtrl',
            data: {
        ...
        .state('detalle-ruta', {
            url: "/detalle-ruta/",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/detalle-ruta.html",
            params : {
                ruta : null
            },
            data: {
        ...
        .state('detalle-acudiente', {
            url: "/detalle-acudiente/",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/detalle-acudiente.html",
            params : {
                acudiente : null
            },
            data: {
                pageTitle: 'Detalle del acudiente'
            }
        })
        .state('trayecto', {
            url: "/trayecto",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/trayecto.html",
            data: {
                pageTitle: 'Trayectos'
            }
        })
        .state('logs', {
            url: "/logs",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/logs.html",
            data: {
                pageTitle: 'Logs'
            }
        })
        .state('detalle-log', {
            url: "/detalle-log",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/detalle-log.html",
            controller : 'logsCtrl',
            data: {
                pageTitle: 'Detalle log'
            },
            params : {
                log : null
            }
        ...
        .state('buses', {
            url: "/buses",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/bus.html",
            data: {
                pageTitle: 'Buses'
            }
        })
        .state('asistencia', {
            url: "/asistencia",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/asistencia.html",
            data: {
                pageTitle: 'Asistencia'
            }
        })
        .state('ruta-estudiante', {
            url: "/ruta-estudiante",
            access: { requiredAuthentication: true },
            templateUrl: "views/school/ruta-estudiante.html",
            data: {
                pageTitle: 'ruta-estudiante'
            }
        })
...
angular
    .module('homer')
    .config(configState)
    .run(function($rootScope, $state, editableOptions, $storage) {
        ...
        if($rootScope.items)
            ...
            if (nextRoute != null && nextRoute.access != null && nextRoute.access.requiredAuthentication && !$storage.get('token')) {
                    ...
                    $state.transitionTo('login', { targetUrl : nextRoute.name});
            }
      });
    });